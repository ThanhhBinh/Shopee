        ...
        <div class="card-body">
            <form action="{{ route('admin.payment.update',['id'=>$payment->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ old('name',$payment->name) }}" name="name" id="name" class="form-control">
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <textarea name="description" value="{{ old('description',$payment->description) }}" id="description" class="form-control">{{ old('description',$payment->description) }}</textarea>
                </div>
